  ...
  return (
    <View className="flex-1">
      <View className="space-y-6">
        ...
        <FormField control={control} name="about_text" label="About Business (optional)" placeholder="Tell candidates about your business..." multiline numberOfLines={4} textAlignVertical="top" />
      </View>
    </View>
  );
}
