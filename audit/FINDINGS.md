...
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| S1  | **PostHog PAT hardcoded in source** — ` grants API-level project access. Committed to git history.                                                                                             | `apps/mobile/app.config.ts:69`                                                  | Rotate key immediately. Move to non-EXPO_PUBLIC env var. Remove from git history with `git filter-branch` or BFG. |
